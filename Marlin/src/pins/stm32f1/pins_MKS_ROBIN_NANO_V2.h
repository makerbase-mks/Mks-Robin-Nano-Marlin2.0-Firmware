...
//
  ...
  #define MKSPWC
    ...
    #define KILL_PIN_INVERTING                true  // Enable MKSPWC PIN STATE
  #endif
  ...
  #define WIFI_IO0_PIN                        PC13  // MSK ESP WIFI IO0 PIN
  #define WIFI_IO1_PIN       			            PC7   // MSK ESP WIFI IO1 PIN
  #define WIFI_RESET_PIN				              PE9   // MSK ESP WIFI RESET PIN
#else
