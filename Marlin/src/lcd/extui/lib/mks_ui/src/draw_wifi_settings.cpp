...
void lv_draw_wifi_settings(void)
{
	...
	lv_btn_set_style(buttonModelText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonModelText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_btn_set_style(buttonNameText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonNameText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_btn_set_style(buttonPassWordText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonPassWordText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_btn_set_style(buttonCloudText, LV_BTN_STYLE_REL, &tft_style_lable_rel);    /*Set the button's released style*/
	lv_btn_set_style(buttonCloudText, LV_BTN_STYLE_PR, &tft_style_lable_pre);      /*Set the button's pressed style*/
	...
	lv_imgbtn_set_style(buttonCloudValue, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonCloudValue, LV_BTN_STATE_REL, &tft_style_lable_rel);
	...
	lv_imgbtn_set_style(buttonConfig, LV_BTN_STATE_PR, &tft_style_lable_pre);
	lv_imgbtn_set_style(buttonConfig, LV_BTN_STATE_REL, &tft_style_lable_rel);
