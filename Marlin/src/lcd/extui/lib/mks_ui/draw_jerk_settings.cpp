...
void lv_draw_jerk_settings(void) {
  ...
  lv_imgbtn_set_src(buttonXValue, LV_BTN_STATE_REL, "bmp_value_blank.bin");
  lv_imgbtn_set_src(buttonXValue, LV_BTN_STATE_PR, "bmp_value_blank.bin");
  ...
  lv_imgbtn_set_src(buttonEValue, LV_BTN_STATE_REL, "F:/bmp_value_blank.bin");
  lv_imgbtn_set_src(buttonEValue, LV_BTN_STATE_PR, "F:/bmp_value_blank.bin");
