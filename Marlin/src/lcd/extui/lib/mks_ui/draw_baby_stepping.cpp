...
void lv_draw_baby_stepping(void) {
  ...
  lv_obj_set_event_cb_mks(buttonXI, event_handler, ID_BABY_STEP_X_P, "bmp_xAdd.bin", 0);
  ...
  lv_obj_clear_protect(buttonXI, LV_PROTECT_FOLLOW);
  #if 1
    lv_obj_set_event_cb_mks(buttonXD, event_handler, ID_BABY_STEP_X_N, "bmp_xDec.bin", 0);
    ...
    lv_obj_set_event_cb_mks(buttonYI, event_handler, ID_BABY_STEP_Y_P, "bmp_yAdd.bin", 0);
    ...
    lv_obj_set_event_cb_mks(buttonYD, event_handler, ID_BABY_STEP_Y_N, "bmp_yDec.bin", 0);
    ...
    lv_obj_set_event_cb_mks(buttonZI, event_handler, ID_BABY_STEP_Z_P, "bmp_zAdd.bin", 0);
    ...
    lv_obj_set_event_cb_mks(buttonZD, event_handler, ID_BABY_STEP_Z_N, "bmp_zDec.bin", 0);
    ...
    lv_obj_set_event_cb_mks(buttonBack, event_handler, ID_BABY_STEP_RETURN, "bmp_return.bin", 0);
...
void disp_baby_step_dist() {
  ...
  if ((int)(100 * babystep_dist) == 1)
    lv_obj_set_event_cb_mks(buttonV, event_handler, ID_BABY_STEP_DIST, "bmp_step_move0_01.bin", 0);
  else if ((int)(100 * babystep_dist) == 5)
    lv_obj_set_event_cb_mks(buttonV, event_handler, ID_BABY_STEP_DIST, "bmp_step_move0_05.bin", 0);
  else if ((int)(100 * babystep_dist) == 10)
    lv_obj_set_event_cb_mks(buttonV, event_handler, ID_BABY_STEP_DIST, "bmp_step_move0_1.bin", 0);
  if (gCfgItems.multiple_language != 0) {
    if ((int)(100 * babystep_dist) == 1) {
...
void lv_clear_baby_stepping() { lv_obj_del(scr); }
