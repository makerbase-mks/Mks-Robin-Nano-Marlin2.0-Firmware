...
void lv_draw_set(void) {
  ...
  lv_big_button_create(scr, ENABLED(HAS_SUICIDE) ? "F:/bmp_power_on_custom.bin" : "F:/bmp_function1.bin", set_menu.TERN(HAS_SUICIDE, shutdown, motoroff), BTN_X_PIXEL * 3 + INTERVAL_V * 4, titleHeight, event_handler, ID_S_MOTOR_OFF);
