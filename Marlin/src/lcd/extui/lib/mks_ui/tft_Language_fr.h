...
#define FILAMENT_CHANGE_TEXT_FR                   "Clickez <Load> ou <unload>, aprés \nla pause de l'imprimante."
#define FILAMENT_DIALOG_LOAD_HEAT_TIPS_FR         "Buse entrain de chauffer,\nveuillez patienter..."
#define FILAMENT_DIALOG_UNLOAD_HEAT_TIPS_FR       "Buse entrain de chauffer,\nveuillez patienter..."
#define FILAMENT_DIALOG_LOAD_CONFIRM1_TIPS_FR     "Buse à température, chargez le filament \net clickez <Confirmer> \npour charger."
#define FILAMENT_DIALOG_LOAD_CONFIRM2_TIPS_FR     "Chargez le filament,\nclickez <Confirmer> pour charger."
#define FILAMENT_DIALOG_UNLOAD_CONFIRM_TIPS_FR    "Buse à température,\nclickez <Confirmer> pour décharger.!"
#define FILAMENT_DIALOG_LOADING_TIPS_FR           "Entrain de charger, veuillez patienter..."
#define FILAMENT_DIALOG_UNLOADING_TIPS_FR         "Entrain de décharger, veuillez patienter..."
#define FILAMENT_DIALOG_LOAD_COMPLETE_TIPS_FR     "Chargement de filament effectué,\nclickez <Confirmer> pour continuer!"
